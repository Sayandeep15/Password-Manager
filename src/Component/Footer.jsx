...
const Footer = () => {
  return (
    <div className=' bg-amber-500 w-full text-white fixed mt-4 top-[91%] transform translate-y-1/2 flex justify-around py-2'>
        <p className='text-xs flex items-center gap-1'><FaRegCopyright />Devoloped by Syanadep Dutta 2025 </p>
